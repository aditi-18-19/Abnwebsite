...
function Navbar() {
  ...
  return (
   ...
   <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 dark:bg-slate-900 dark:text-white  ${
    sticky?"sticky-navbar shadow-md bg-base-300 dark:bg-slate-700 dark:text-white duration-200 transition-all ease-in-out":""}`} >
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointer">AbnConst</a>
  </div>
